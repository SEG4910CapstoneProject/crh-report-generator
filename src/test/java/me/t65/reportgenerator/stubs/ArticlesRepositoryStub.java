...
@Component
public class ArticlesRepositoryStub implements ArticlesRepository {
    ...
    @Override
    public Page<ArticlesEntity> findByDateIngestedAfter(Instant dateIngested, Pageable pageable) {
        return null;
    }
}
